...
layui.use(['form', 'layedit', 'laydate', 'element'], function () {
    ...
    $.get(group.baseUrl + '/allGropByUser', null, function (data) {
        allItems = data;
    });
        ...
        if (group.select(layerTips)) {
            var id = group.currentItem.id;
              window.spindex =layer.open({
                ...
                ,area: ['100%', '100%']
                ,shade: 0.5
                ,content: group.entity + '/user2?groupid='+id
            });
        }
                ...
                var index = layer.open({
                    ...
                    success: function (layero, index) {
                        ...
                        $.get(group.baseUrl + '/' + id + "/user", null, function (data) {
                            ...
                            layero.find("#aaaa").append(leaOpts).trigger('change');
                        });
                ...
                var index = layer.open({
                    ...
                    success: function (layero, index) {
                        ...
                        $.ajax({
                            ...
                            url: "/back/menu/user/authorityTreeByUser",
