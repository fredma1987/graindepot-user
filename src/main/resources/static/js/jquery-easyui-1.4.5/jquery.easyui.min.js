...
},beforePageText:"当前页数",afterPageText:"共{pages}页",displayMsg:"显示从 {from} 至 {to} 项   共 {total} 项",nav:{first:{iconCls:"pagination-first",handler:function(){
